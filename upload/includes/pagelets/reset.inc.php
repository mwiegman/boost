...
<div id="confirm-modal" class="modal fade" tabindex="-1">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <p>If the username you entered exists, a password reset link has been sent. Please check your email.</p>
      </div>
...
//check user input
  ...
  if ($u && $e) {//validation passes
    ...
    if (mysqli_num_rows($r) == 1) {//confirmed
      ...
      $q = "UPDATE users SET reset = '$reset', reset_expire = DATE_ADD(NOW(), INTERVAL 4 HOUR) WHERE email = '$e' && username = '$u'";
      $r = mysqli_query ($dbc, $q);
...
<div class="container">
  ...
  <div class="row">
    ...
    <form class="col-md-4 col-md-offset-4" action="" method="post" id="reset">
      ...
      <a href="index.php?pagelet=login"><small>Return to Log In</small></a>
     </div>
